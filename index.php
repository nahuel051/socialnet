   ...
   ORDER BY p.fecha_publicacion DESC";
            ...
            while ($row_publicacion = mysqli_fetch_array($result_publicaciones)) {
                ...
                <div class="content-post">
                    <a class="username"
                        href="<?php echo $row_publicacion['id_usuario'] == $id_usuario_sesion ? 'perfil.php' : 'otro_perfil.php?id_usuario=' . $row_publicacion['id_usuario']; ?>">
                    ...
                    <div class="like">
                        ...
                        ?>
                        <a class="like-index" href="cantidad_like.php?id_publicacion=<?php echo $id_publicacion; ?>">a
                            <?php echo $total_like; ?> les gusta</a>
